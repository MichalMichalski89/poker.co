...
(function () {
    function B(f, k) {
        for (var g, m = f.length; m--; )
            (g = f[m].replace("#", "")), (g = "rgba(" + parseInt(g.substring(0, 2), 16) + "," + parseInt(g.substring(2, 4), 16) + "," + parseInt(g.substring(4, 6), 16)), (g = k ? g + ("," + k.toFixed(2) + ")") : g + ")"), (f[m] = g);
        return f;
    }
    function t(f) {
        ...
        return (f = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(f)) ? { r: parseInt(f[1], 16), g: parseInt(f[2], 16), b: parseInt(f[3], 16) } : null;
    }
    window.RsParticlesAddOn = function (f) {
        function k(a, b) {
            ...
            c >= p && c <= n
                ? ((u = "." + r + "-tp-particles-" + c), v ? w || pJSDomRs[x].pJS.fn.vendors.draw() : ((v = !0), (x = pJSDomRs.length), particlesJSRs(u, l, r, q, f)), (y = setTimeout(m, 100)), (w = !0))
                : v && (rspCancelAnimFrame(pJSDomRs[x].pJS.fn.drawAnimFrame), (document.getElementById(q).style.opacity = 0), (w = !1));
        ...
        if (f) {
            ...
            if (b.enable || (d.enable && "grab" === d.mode)) for (b = b.color = b.color.split(","), d = b.length; d--; ) b[d] = t(b[d]);
            "image" === c.type &&
                ((c = c.image),
                ...
                a ? ((b = 2 * a + 24), (c.src = c.src.replace("{{stroke-width}}", a).replace("{{viewbox}}", -a + " " + -a + " " + b + " " + b))) : (c.src = c.src.replace("{{viewbox}}", "0 0 24 24").replace("{{stroke-width}}", 0)));
    ...
    window.RsDestroyParticles = function (f) {
        if (pJSDomRs)
            ...
            } else for (; pJSDomRs.length; ) jQuery("#" + PJSDomRs[0].tpId).off("revolution.slide.onbeforeswap revolution.slide.onloaded .rsparticles"), pJSDomRs[0].pJS.fn.vendors.destroypJS(), pJSDomRs.shift();
    };
    var C = function (f, k, g, m, l) {
        function p(b, c, d, h, f, g, e, k) {
            h != f &&
                (a.tmp.bubble_duration_end
                    ? void 0 != g && ((c = h + (h - (e - (d * (e - h)) / a.interactivity.modes.bubble.duration))), "size" == k && (b.radius_bubble = c), "opacity" == k && (b.opacity_bubble = c))
                    : c <= a.interactivity.modes.bubble.distance
                    ? (void 0 != g ? g : e) != h && ((c = e - (d * (e - h)) / a.interactivity.modes.bubble.duration), "size" == k && (b.radius_bubble = c), "opacity" == k && (b.opacity_bubble = c))
                    : ("size" == k && (b.radius_bubble = void 0), "opacity" == k && (b.opacity_bubble = void 0)));
        }
        function n() {
            return this.color.rgb
                ? "rgba(" + this.color.rgb.r + "," + this.color.rgb.g + "," + this.color.rgb.b + "," + this.opacity.toFixed(2) + ")"
                : "hsla(" + this.color.hsl.h + "," + this.color.hsl.s + "%," + this.color.hsl.l + "%," + this.opacity.toFixed(2) + ")";
        }
        this.tpId = m;
        var a = (this.pJS = {
            ...
            particles: {
                ...
                opacity: { value: 1, random: !1, min: 0.1, anim: { enable: !1, speed: 2, opacity_min: 0, sync: !1 } },
                ...
                move: { enable: !0, speed: 2, direction: "none", random: !1, min_speed: 1, straight: !1, out_mode: "out", bounce: !1, attract: { enable: !1, rotateX: 3e3, rotateY: 3e3 } },
                array: [],
            },
            interactivity: {
                detect_on: "canvas",
        ...
        a.fn.particle = function (b, c, d) {
            ...
            "object" == typeof b.value
                ? b.value instanceof Array
                    ? (this.color.rgb = t(b.value[Math.floor(Math.random() * a.particles.color.value.length)]))
                    : (void 0 != b.value.r && void 0 != b.value.g && void 0 != b.value.b && (this.color.rgb = { r: b.value.r, g: b.value.g, b: b.value.b }),
                      void 0 != b.value.h && void 0 != b.value.s && void 0 != b.value.l && (this.color.hsl = { h: b.value.h, s: b.value.s, l: b.value.l }))
                : "random" == b.value
            ...
            a.particles.move.straight ? ((this.vx = b), (this.vy = d)) : ((this.vx = b + Math.random() - 0.5), (this.vy = d + Math.random() - 0.5));
            this.vx_i = this.vx;
            this.vy_i = this.vy;
            ...
            "image" == this.shape &&
                ((b = a.particles.shape),
                (this.img = { src: b.image.src, ratio: b.image.width / b.image.height }),
                this.img.ratio || (this.img.ratio = 1),
                "svg" == a.tmp.img_type && void 0 != a.tmp.source_svg && (a.fn.vendors.createSvgImg(this), a.tmp.pushing && (this.img.loaded = !1)));
        };
        ...
        a.fn.particle.prototype.draw = function () {
            ...
            a.canvas.ctx.fillStyle = this.color.rgb
                ? "rgba(" + this.color.rgb.r + "," + this.color.rgb.g + "," + this.color.rgb.b + "," + d + ")"
                : "hsla(" + this.color.hsl.h + "," + this.color.hsl.s + "%," + this.color.hsl.l + "%," + d + ")";
            ...
            switch (this.shape) {
                ...
                case "triangle":
                    ...
                    break;
                case "polygon":
                    a.fn.vendors.drawShape(a.canvas.ctx, this.x - c / (a.particles.shape.polygon.nb_sides / 3.5), this.y - c / 0.76, (2.66 * c) / (a.particles.shape.polygon.nb_sides / 3), a.particles.shape.polygon.nb_sides, 1);
                    break;
                case "star":
            ...
            b || (0 < a.particles.shape.stroke.width && ((a.canvas.ctx.strokeStyle = this.strokeColor), (a.canvas.ctx.lineWidth = a.particles.shape.stroke.width), a.canvas.ctx.stroke()), a.canvas.ctx.fill());
        };
        ...
        a.fn.particlesUpdate = function () {
            for (var b, c, d, h, f = a.particles.array.length, g = 0; g < f; g++) {
                ...
                a.particles.opacity.anim.enable &&
                    (1 == e.opacity_status ? (e.opacity >= e.opc && (e.opacity_status = !1), (e.opacity += e.vo)) : (e.opacity <= a.particles.opacity.anim.opacity_min && (e.opacity_status = !0), (e.opacity -= e.vo)),
                    0 > e.opacity && (e.opacity = 0));
                a.particles.size.anim.enable &&
                    (1 == e.size_status ? (e.radius >= a.particles.size.value && (e.size_status = !1), (e.radius += e.vs)) : (e.radius <= a.particles.size.anim.size_min && (e.size_status = !0), (e.radius -= e.vs)),
                    0 > e.radius && (e.radius = 0));
                "bounce" == a.particles.move.out_mode ? ((b = e.radius), (c = a.canvas.w), (d = e.radius), (h = a.canvas.h)) : ((b = -e.radius), (c = a.canvas.w + e.radius), (d = -e.radius), (h = a.canvas.h + e.radius));
        ...
        a.fn.interact.linkParticles = function (b, c) {
            ...
            d <= a.particles.line_linked.distance &&
                ((d = a.particles.line_linked.opacity - d / (1 / a.particles.line_linked.opacity) / a.particles.line_linked.distance),
                0 < d &&
                    ((h = b.lineColor),
        ...
        a.fn.modes.pushParticles = function (b, c) {
            b |= 0;
            a.tmp.pushing = !0;
            for (var d = 0; d < b; d++) a.particles.array.push(new a.fn.particle(a.particles.color, a.particles.opacity.value, { x: c ? c.pos_x : Math.random() * a.canvas.w, y: c ? c.pos_y : Math.random() * a.canvas.h }));
            ...
            if (a.interactivity.events.onhover.enable && -1 < a.interactivity.events.onhover.mode.indexOf("bubble")) {
                ...
                c <= a.interactivity.modes.bubble.distance
                    ? 0 <= d &&
                      ...
                      (a.interactivity.modes.bubble.size != b.radius &&
                          (a.interactivity.modes.bubble.size > b.radius
                              ? ((c = b.radius + a.interactivity.modes.bubble.size * d), 0 <= c && (b.radius_bubble = c))
                              : ((c = b.radius - (b.radius - a.interactivity.modes.bubble.size) * d), (b.radius_bubble = 0 < c ? c : 0))),
                      a.interactivity.modes.bubble.opacity != b.opc &&
                          (a.interactivity.modes.bubble.opacity > b.opc
                              ? ((c = a.interactivity.modes.bubble.opacity * d), c > b.opacity && c <= a.interactivity.modes.bubble.opacity && (b.opacity_bubble = c))
                              : ((c = b.opacity - (b.opc - a.interactivity.modes.bubble.opacity) * d), c < b.opacity && c >= a.interactivity.modes.bubble.opacity && (b.opacity_bubble = c))))
                ...
                a.interactivity.events.onclick.enable &&
                    ...
                    (a.tmp.bubble_clicking &&
                        ...
                        d > 2 * a.interactivity.modes.bubble.duration && ((a.tmp.bubble_clicking = !1), (a.tmp.bubble_duration_end = !1))),
                    a.tmp.bubble_clicking && (p(b, c, d, a.interactivity.modes.bubble.size, b.osize, b.radius_bubble, b.radius, "size"), p(b, c, d, a.interactivity.modes.bubble.opacity, b.opc, b.opacity_bubble, b.opacity, "opacity")));
        };
        a.fn.modes.repulseParticle = function (b) {
            ...
            if (a.interactivity.events.onhover.enable && -1 < a.interactivity.events.onhover.mode.indexOf("repulse") && "mousemove" == a.interactivity.status) {
                ...
                c = b.x + (h / f) * g;
                d = b.y + (d / f) * g;
                "bounce" == a.particles.move.out_mode ? (0 < c - b.radius && c + b.radius < a.canvas.w && (b.x = c), 0 < d - b.radius && d + b.radius < a.canvas.h && (b.y = d)) : ((b.x = c), (b.y = d));
            } else
                a.interactivity.events.onclick.enable &&
                    -1 < a.interactivity.events.onclick.mode.indexOf("repulse") &&
                    (a.tmp.repulse_finish || (a.tmp.repulse_count++, a.tmp.repulse_count == a.particles.array.length && (a.tmp.repulse_finish = !0)),
                        ...
                        ? ((c = Math.pow(a.interactivity.modes.repulse.distance / 6, 3)),
                          ...
                          g <= c &&
                              ...
                              "bounce" == a.particles.move.out_mode &&
                                  ((c = b.x + b.vx), (d = b.y + b.vy), c + b.radius > a.canvas.w ? (b.vx = -b.vx) : 0 > c - b.radius && (b.vx = -b.vx), d + b.radius > a.canvas.h ? (b.vy = -b.vy) : 0 > d - b.radius && (b.vy = -b.vy))))
                        ...
                        switch (a.interactivity.events.onclick.mode) {
                            case "push":
                                a.particles.move.enable
                                    ...
                                    ? a.fn.modes.pushParticles(a.interactivity.modes.push.particles_nb, a.interactivity.mouse)
                                    : 1 < a.interactivity.modes.push.particles_nb && a.fn.modes.pushParticles(a.interactivity.modes.push.particles_nb);
                                break;
                            case "remove":
            ...
            "image" == a.particles.shape.type
                ? "svg" == a.tmp.img_type
                    ? a.tmp.count_svg >= a.particles.number.value
                        ? (a.fn.particlesDraw(), a.particles.move.enable ? (a.fn.drawAnimFrame = rspRequestAnimFrame(a.fn.vendors.draw)) : rspCancelAnimFrame(a.fn.drawAnimFrame))
                        : a.tmp.img_error || (a.fn.drawAnimFrame = rspRequestAnimFrame(a.fn.vendors.draw))
        ...
        a.fn.vendors.checkBeforeDraw = function () {
            "image" == a.particles.shape.type
                ? "svg" == a.tmp.img_type && void 0 == a.tmp.source_svg
                    ...
                    : (rspCancelAnimFrame(a.tmp.checkAnimFrame), a.tmp.img_error || (a.fn.vendors.init(), a.fn.vendors.draw()))
        ...
        a.fn.vendors.start = function () {
            -1 < a.particles.shape.type.indexOf("image") ? ((a.tmp.img_type = "svg"), a.fn.vendors.loadImg(a.tmp.img_type, a.particles.shape.image.src)) : a.fn.vendors.checkBeforeDraw();
        };
