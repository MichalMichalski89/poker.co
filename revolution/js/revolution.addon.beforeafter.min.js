...
(function () {
    ...
    function t(a, c, b, e, g, h, k, d, f, p, n, q, l, r) {
        ...
        this.globals.hasOwnProperty("onClick") && ((a = this.globals.onClick.easing.split(".")), (this.time = 0.001 * parseInt(this.globals.onClick.time, 10)), (this.transition = punchgs[a[0]][a[1]]));
        ...
        d.hasOwnProperty("bounceArrows") &&
            ((this.bounceArrows = d.bounceArrows), (this.bounceDelay = parseInt(d.bounceDelay, 10)), (this.readyArrows = this.arrowsReady.bind(this)), this.bounceDelay && (this.delayBounce = this.bounceReady.bind(this)));
    ...
    w.prototype = {
        ...
        onLoaded: function () {
            ...
            this.slider
                ...
                .each(function () {
                    ...
                    else if ("trans" !== n && (n = b.data("beforeafter-video")) && (n.closest(".tp-parallax-wrap").addClass("rs-video-beforeafter"), !a.carousel)) {
                        var q = n;
                    ...
                    a.slides[a.slides.length] = new t(c, p, h, b, q, l, f, k, g[0], d[0], a.slider, a.options, a.carousel, b.attr("data-index"));
                });
            this.init();
        },
        ...
        afterSwap: function (a, c) {
            !this.checkRemoved() &&
                ...
                this.slide.setup || (this.onResize(!1, !0), this.slide.onSetup(), this.slider.on("revolution.slide.afterdraw", this.resize)),
                this.slide.reset(!0),
                this.slide.reveal(),
                ...
                if (b) {
                    ...
                    for (var h = k / this.widths[g], f = this.slides.length; f--; )
                        (e = this.slides[f]),
                            ...
                            (e.sliderWidth = k),
                            (e.sliderHeight = d),
                            e.normal ? ((e.bgInner.style.width = k + "px"), (e.inner.style.width = k + "px")) : ((e.bgInner.style.height = d + "px"), (e.inner.style.height = d + "px"));
                    c ||
                        (b.normal
                            ? ((k = b.moveto[b.level]), -1 === k.search("%") && (k = (parseInt(k, 10) * h).toFixed(0) + "px"), (d = "50%"))
                            : ((k = "50%"), (d = b.moveto[b.level]), -1 === d.search("%") && (d = (parseInt(d, 10) * h).toFixed(0) + "px")),
                        b.resetDrag(k, d));
                }
            }
        },
    ...
    t.prototype = {
        createDrag: function () {
            ...
            this.normal
                ? ((e = "padding-right"),
                  ...
                  (c = b.leftIcon),
                  (b = b.rightIcon),
                  this.bounceArrows && ((f = " rs-" + this.id + "-" + this.index + "-rs-beforeafter-bounce-"), (p = f + "left"), (f += "right")),
                  this.shiftArrows && ((n = "transform: translateX(-" + this.shiftArrows + "px);"), (q = "transform: translateX(" + this.shiftArrows + "px);")))
                : ((e = "margin-bottom"),
                  (g = "margin-top"),
                  (c = b.topIcon),
                  (b = b.bottomIcon),
                  this.bounceArrows && ((f = " rs-" + this.id + "-" + this.index + "-rs-beforeafter-bounce-"), (p = f + "top"), (f += "bottom")),
                  this.shiftArrows && ((n = "transform: translateY(-" + this.shiftArrows + "px);"), (q = "transform: translateY(" + this.shiftArrows + "px);")));
            a += '" />';
            ...
            d &&
                ((h =
                    ...
                    "px; background-color: " +
                    h.color),
                k && (h += "; box-shadow: 0px 0px " + parseInt(k.blur, 10) + "px " + parseInt(k.strength, 10) + "px " + k.color + ";"),
            ...
            if (!this.supress && !this.blurred)
                if (this.prevent) this.prevent = !1;
                    ...
                    e ||
                        ...
                        (e = a.pageY - c.top),
                        this.normal
                            ? ((c = b), (a = this.sliderWidth), (e = Math.min(this.sliderHeight - this.buffer, Math.max(e, this.buffer))))
                            : ((c = e), (a = this.sliderHeight), (b = Math.min(this.sliderWidth - this.buffer, Math.max(b, this.buffer)))),
        ...
        fade: function () {
            ...
            this.revealLine && punchgs.TweenLite.to(this.revealLine, 0.3, { autoAlpha: 0, ease: punchgs.Power2.easeInOut });
        },
        collapse: function () {
        ...
        playVideo: function () {
            m.fn.revolution.playAnimationFrame({ caption: this.videoBg, opt: this.slider[0].opt, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" });
        },
        checkVideo: function () {
        ...
        reveal: function () {
            ...
            this.revealLine &&
                ((h = { ease: this.animation, delay: this.delay }), (h[this.axis] = a), punchgs.TweenLite.to(this.revealLine, 0.3, { autoAlpha: 1, ease: punchgs.Power2.easeOut }), punchgs.TweenLite.to(this.revealLine, this.timing, h));
            punchgs.TweenLite.to(this.revealBtn, 0.3, { autoAlpha: 1, ease: punchgs.Power2.easeOut });
            punchgs.TweenLite.to(this.revealBtn, this.timing, { delay: this.delay, left: e, top: g, ease: this.animation, onComplete: this.complete });
        },
        destroy: function () {
                ...
                e.each(function () {
                    ...
                    if (/html5|youtube|vimeo/.test(d.bgType)) {
                        var f =
                            ...
                            ('[{"delay":"' + (d.carousel ? "10" : "bytrigger") + '","speed":0,"frame":"0","to":"o:1;","ease":"Linear.easeNone"},{"delay":"wait","speed":0,"frame":"999","ease":"Linear.easeNone"}]') +
                            ...
                            case "youtube":
                                if ((g = d.videoId))
                                    (f += 'data-ytid="' + g + '" '),
                                        ...
                                        (f = d.muteVideo ? f + 'data-volume="mute" ' : f + ('data-volume="' + d.videoVolume + '" ')),
                                        (l = !0);
                                break;
                            case "vimeo":
                                if ((g = d.videoId))
                                    (f += 'data-vimeoid="' + g + '" '), (f += 'data-videoattributes="' + d.vimeoArgs + '" '), (f = d.muteVideo ? f + 'data-volume="mute" ' : f + ('data-volume="' + d.videoVolume + '" ')), (l = !0);
                        }
                    ...
                    if (d.hasOwnProperty("shiftOffset"))
                        for (c = 0.001 * parseInt(d.shiftTiming, 10), l = 0.001 * parseInt(d.shiftDelay, 10), f = 0; 2 > f; f++)
                            (g = d.shiftEasing), (a += ".rs-beforeafter-shift-arrows .rs-" + b + "-" + e + "-rs-beforeafter-shift {-webkit-transition: all " + c + "s " + g + " " + l + "s;transition: all " + c + "s " + g + " " + l + "s}");
                });
                if (a) {
