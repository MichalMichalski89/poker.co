...
!(function (e) {
    e.fn.skillBars = function (t) {
        var a = e.extend({ from: 0, to: !1, speed: 1e3, interval: 100, decimals: 0, onUpdate: null, onComplete: null, classes: { skillBarBar: ".skillbar-bar", skillBarPercent: ".skill-bar-percent" } }, t);
        return this.each(function () {
            var t = e(this),
            ...
            t.find(a.classes.skillBarBar).animate({ width: parseInt(t.attr("data-percent")) + "%" }, a.speed);
        });
    };
})(jQuery);
...
(function (i) {
    ...
    (function () {
        for (var k = 0, l = ["ms", "moz", "webkit", "o"], m = 0; m < l.length && !window.requestAnimationFrame; ++m)
            ...
            return this.each(function () {
                function l(Y) {
                    return (
                        ...
                        (N = r.width()),
                        j() && (U = 2),
                        ("left" === X.parallaxDirection || "right" === X.parallaxDirection) && (F += U * Math.ceil(N * parseFloat(X.parallaxSpeed))),
                        ("up" === X.parallaxDirection || "down" === X.parallaxDirection) && (B += U * Math.ceil(M * parseFloat(X.parallaxSpeed))),
                        [F, B]
                    );
                }
                function m(Y, Z) {
                ...
                var q = i(this),
                    ...
                    U = 1,
                    W = q.data(),
                    X = i.extend({}, { parallaxBgImage: "", parallaxBgPosition: "center center", parallaxBgRepeat: "no-repeat", parallaxBgSize: "cover", parallaxSpeed: 0.5, parallaxDirection: "up" }, k, W);
                1 < X.parallaxSpeed ? (X.parallaxSpeed = 1) : 0 > X.parallaxSpeed && (X.parallaxSpeed = 0),
                    1 > q.find(".parallax-inner").length && q.prepend('<div class="parallax-inner"></div>'),
                    (u = q.find(".parallax-inner")),
                    (v = l(q)),
                    (A = m(q, v)),
                    q.css({ position: "relative", background: "transparent", overflow: "hidden", "z-index": "1" }),
                    u.css({
                        position: "absolute",
                    ...
                    r.on("resize", function () {
                        (v = l(q)), (A = m(q, v)), u.css({ width: v[0], height: v[1], transform: "translate3d(" + A[0] + "px, " + A[1] + "px, " + A[2] + "px)" });
                    }),
                    ("left" === X.parallaxDirection || "right" === X.parallaxDirection) && ((C = 0), (D = A[0])),
                    ("up" === X.parallaxDirection || "down" === X.parallaxDirection) && ((C = 0), (D = A[1])),
                    (P = r.scrollTop()),
                        ...
                        0 < P && (T = o(P)),
                            ...
                            q.isOnScreen()
                                ? ((C = T * (parseFloat(X.parallaxSpeed) / 4)),
                                  "up" === X.parallaxDirection && n(q) > n(u) + 50 && ((D += -C), (E = "translate3d(" + A[0] + "px, " + D + "px, " + A[2] + "px)")),
                                  "down" === X.parallaxDirection && n(q) + 50 < n(u) && ((D += C), (E = "translate3d(" + A[0] + "px, " + D + "px, " + A[2] + "px)")),
                                  "left" === X.parallaxDirection && n(q) + 50 < n(u) && ((D += C), (E = "translate3d(" + D + "px, " + A[1] + "px, " + A[2] + "px)")),
                                  "right" === X.parallaxDirection && n(q) > n(u) + 50 && ((D += -C), (E = "translate3d(" + D + "px, " + A[1] + "px, " + A[2] + "px)")),
                                  u.css({ width: v[0], height: v[1], transform: E }))
                                : (("up" === X.parallaxDirection || "down" === X.parallaxDirection) && (D = A[1]),
                                  ("left" === X.parallaxDirection || "right" === X.parallaxDirection) && (D = A[0]),
                                  u.css({ width: v[0], height: v[1], transform: "translate3d(" + A[0] + "px, " + A[1] + "px, " + A[2] + "px)" }));
                    });
            });
        });
})(jQuery);
...
!(function (a) {
    ...
    (function (a, b) {
        "function" == typeof define && define.amd
            ? define(["outlayer/outlayer", "get-size/get-size", "fizzy-ui-utils/utils"], b)
            : "object" == typeof exports
...
!(function (e) {
    ...
    var t = void 0 !== document.ontouchstart,
        s = {
            init: function (t) {
                return (
                    (t = e.extend({ iscroll: { mouseWheel: !0, preventDefault: !1 }, showOverlay: !0 }, t)),
                    (s.settings = { state: !1, events: { opened: "side-menu.opened", closed: "side-menu.closed" }, dropdownEvents: { opened: "shown.bs.dropdown", closed: "hidden.bs.dropdown" } }),
                    (s.settings.class = e.extend({ nav: "side-menu-nav", toggle: "side-menu-toggle", overlay: "side-menu-overlay", open: "side-menu-open", close: "side-menu-close", dropdown: "side-menu-dropdown" }, t.class)),
                    this.each(function () {
                        var n = this,
                            r = e(this);
                        r.data("side-menu") ||
                            ...
                            e("." + s.settings.class.toggle).on("click.side-menu", function () {
        ...
        (t.typeIt.prototype = {
            _init: function () {
                this.el.find(".ti-container, .ti-cursor, .ti-placeholder").remove(),
                    ...
                    this.s.startDelete && (this.tel.html(this.stringsToDelete), this.queue.push([this["delete"]])),
                    this._generateQueue(),
                    this._kickoff();
            },
            _kickoff: function () {
                ...
                for (var e = 0; e < t.length; e++)
                    if (((t[e] = t[e].split("")), this.s.html)) {
                        ...
                        for (var i, s = this.tPos, h = !1, n = 0; n < t[e].length; n++)
                            ("<" !== t[e][n] && "&" !== t[e][n]) || ((s[0] = n), (h = "&" === t[e][n])),
                                (">" === t[e][n] || (";" === t[e][n] && h)) && ((s[1] = n), (n = 0), (i = t[e].slice(s[0], s[1] + 1).join("")), t[e].splice(s[0], s[1] - s[0] + 1, i), (h = !1));
                    }
                return t;
            },
    ...
    (e.fn.fullpage = function (l) {
        ...
        function be() {
            Rt.css({ height: "100%", position: "relative" }),
                ...
                l.scrollOverflow ? ("complete" === t.readyState && Me(), ne.on("load", Me)) : He();
        }
        function xe(n, t, o) {
            var i = 100 * o,
                r = 100 / o;
        ...
        function ke(e) {
            e.find(F).after('<div class="' + Q + '"></div><div class="' + $ + '"></div>'),
                "#fff" != l.controlArrowColor &&
                    (e.find(ee).css("border-color", "transparent transparent transparent " + l.controlArrowColor), e.find(_).css("border-color", "transparent " + l.controlArrowColor + " transparent transparent")),
                ...
                if (((n = e(d).eq(r)), !n.hasClass(p))) {
                    ...
                    C.length && ((v = C.data("anchor")), (h = C.index())),
                        Dt &&
                            ...
                            l.resetSliders && At.resetSliders && At.resetSliders.apply({ localIsResizing: zt, leavingSection: m }),
                            ln(g),
                            on(n),
                            rn(n),
                            Pn(w, x - 1),
            ...
            if (!Ze(n.target) && Ye(t)) {
                ...
                ($t = a.y),
                    ...
                    i.find(F).length && o.abs(Jt - eo) > o.abs(Kt - $t)
                        ? !Mt && o.abs(Jt - eo) > (ne.outerWidth() / 100) * l.touchSensitivity && (Jt > eo ? Ft.m.right && ue(i) : Ft.m.left && he(i))
                        : l.autoScrolling && Dt && o.abs(Kt - $t) > (ne.height() / 100) * l.touchSensitivity && (Kt > $t ? Ve("down", r) : $t > Kt && Ve("up", r));
            }
        }
        function Ze(n, t) {
            t = t || 0;
            ...
            if ("undefined" != typeof n && n.length) {
                ...
                (s.activeSection.is(n) && !zt) ||
                    ...
                    (e.isFunction(l.onLeave) && !s.localIsResizing && l.onLeave.call(s.activeSection, s.leavingSection, s.sectionIndex + 1, s.yMovement) === !1) ||
                        (vt("scrollOverflowReset") && At.scrollOverflowReset.setPrevious(s.activeSection),
        ...
        function en(n) {
            n.wrapAroundElements &&
                ...
                (n.isMovementUp ? e(x).before(n.wrapAroundElements) : e(C).after(n.wrapAroundElements), ct(e(b).position().top), Xe(), (n.sectionIndex = n.element.index(y)), (n.leavingSection = n.activeSection.index(y) + 1));
        }
        function nn(n) {
            en(n),
            ...
            return e("html").hasClass(u)
                ...
                : (l.continuousVertical && (l.loopTop || l.loopBottom) && ((l.continuousVertical = !1), bt("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
                  ...
                  !l.continuousVertical ||
                      ...
                      ((l.continuousVertical = !1), bt("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
...
+(function (t) {
    ...
    var a = function (r, o) {
        ...
        for (var i in o.custom) if (!o.errors[i]) throw new Error("Missing default error message for custom validator: " + i);
        t.extend(a.VALIDATORS, o.custom),
            this.$element.attr("novalidate", !0),
            this.toggleSubmit(),
            this.$element.on("input.bs.validator change.bs.validator focusout.bs.validator", a.INPUT_SELECTOR, t.proxy(this.onInput, this)),
    ...
    (a.INPUT_SELECTOR = ':input:not([type="submit"], button):enabled:visible'),
            ...
            if ((this.$element.trigger(n), !n.isDefaultPrevented())) {
                ...
                return this.runValidators(r).done(function (e) {
                    r.data("bs.validator.errors", e),
                        e.length ? (a ? d.defer(r, d.showErrors) : d.showErrors(r)) : d.clearErrors(r),
                        (s && e.toString() === s.toString()) ||
                            ((n = e.length ? t.Event("invalid.bs.validator", { relatedTarget: r[0], detail: e }) : t.Event("valid.bs.validator", { relatedTarget: r[0], detail: s })), d.$element.trigger(n)),
                        d.toggleSubmit(),
                        d.$element.trigger(t.Event("validated.bs.validator", { relatedTarget: r[0] }));
                });
            }
        }),
        ...
        (a.prototype.focusError = function () {
            if (this.options.focus) {
                ...
                0 !== e.length && (t(document.body).animate({ scrollTop: e.offset().top - a.FOCUS_OFFSET }, 250), e.focus());
            }
        }),
        (a.prototype.showErrors = function (e) {
            ...
            a.length &&
                ...
                o.hasClass("has-feedback") && s.removeClass(this.options.feedback.success) && s.addClass(this.options.feedback.error) && o.removeClass("has-success"));
        }),
        (a.prototype.clearErrors = function (t) {
            ...
            a.html(a.data("bs.validator.originalContent")),
                ...
                r.hasClass("has-feedback") && o.removeClass(this.options.feedback.error) && e(t) && o.addClass(this.options.feedback.success) && r.addClass("has-success");
        }),
        ...
        event: function () {
            ...
            if ((o && a.wrap("<div class='wrap-sticky'></div>"), a.hasClass("brand-center"))) {
                ...
                r(i),
                    ...
                    e.find("ul.nav.navbar-left").wrap("<div class='col-half left'></div>"),
                    e.find("ul.nav.navbar-right").wrap("<div class='col-half right'></div>"),
                    e.find("ul.navbar-nav > li").each(function () {
            ...
            a.hasClass("navbar-sidebar") ? (n("body").addClass("wrap-nav-sidebar"), a.wrapInner("<div class='scroller'></div>")) : n(".bootsnav").addClass("on"),
                a.find("ul.nav").hasClass("navbar-center") && a.addClass("menu-center"),
                a.hasClass("navbar-full")
                    ? (n("nav.navbar.bootsnav").find("ul.nav").wrap("<div class='wrap-full-menu'></div>"),
                      n(".wrap-full-menu").wrap("<div class='nav-full'></div>"),
                      n("ul.nav.navbar-nav").prepend("<li class='close-full-menu'><a href='#'><i class='fa ion-android-close'></i></a></li>"))
                              ...
                              n("a.dropdown-toggle", this).off("click"),
                                  ...
                                  n(this).on("mouseleave", function () {
                                      return (
                                          ...
                                          n(".col-menu", this).find(".content").stop().fadeOut().removeClass(e),
                                          n(".col-menu", this).removeClass("on"),
                                          n("li.dropdown", this).removeClass("on"),
                                          !1
                                      );
...
!(function (a, b, c, d) {
    ...
    function e(b, c, d) {
        ...
        a.data(b, "cubeportfolio", g),
            ...
            (g.$obj = a(b)),
            (f = g.$obj.children()),
            g.options.caption && ("expand" === g.options.caption || e.Private.modernBrowser || (g.options.caption = "minimal"), (h += " cbp-caption-active cbp-caption-" + g.options.caption)),
            g.$obj.addClass(h),
            (0 === f.length || f.first().hasClass("cbp-item")) && (g.wrapInner(g.obj, "cbp-wrapper"), (g.addedWrapp = !0)),
    ...
    a.extend(e.prototype, {
            ...
            e.Private.initResizeEvent({
                ...
                fn: function () {
                    ...
                    b.triggerEvent("beforeResizeGrid"),
                        (a = b.$obj.outerWidth()),
                        b.width !== a &&
                            ("alignCenter" === b.options.gridAdjustment && (b.wrapper[0].style.maxWidth = ""), (b.width = a), b.layoutAndAdjustment(), "slider" === b.options.layoutMode && b.updateSlider(), b.triggerEvent("resizeGrid")),
        ...
        getColsMosaic: function (a) {
            ...
            return (c = c % 1 >= 0.79 ? Math.ceil(c) : Math.floor(c)), Math.min(Math.max(c, 1), b.cols);
        },
        ...
        getColumnsBreakpoints: function () {
            ...
            return (
                ...
                b === d && (b = c.options.mediaQueries[c.options.mediaQueries.length - 1].cols),
                b
            );
        },
        ...
        addItems: function (b, c) {
            ...
            d.wrapInner(b, "cbp-item-wrapper"),
                b.addClass("cbp-item-loading").css({ top: "100%", left: 0 }).appendTo(d.$ul),
                e.Private.modernBrowser
                        ...
                        getNewItems: function () {
                            ...
                            e.isActive ||
                                ...
                                b > d ||
                                    ...
                                    e.numberOfClicks++,
                                    a
                                        .ajax({ url: c.loadMore.attr("href"), type: "GET", dataType: "HTML", cache: !0 })
                                        .done(function (b) {
                                            var d, f;
                                            (d = a(b).filter(function () {
                                                ...
                                                c.parent.$obj.cubeportfolio("appendItems", d.html(), function () {
                                                    (f = a(b).filter(function () {
                                                        ...
                                                        0 === f.length
                                                            ? (c.loadMore.addClass("cbp-l-loadMore-stop"), e.window.off("scroll.loadMoreObject"), c.parent.$obj.off("filterComplete.cbp"))
                                                            : ((e.isActive = !1), e.window.trigger("scroll.loadMoreObject"));
                                                });
                                        })
                                        .fail(function () {
                                            e.isActive = !1;
            ...
            f = {
                    ...
                    if (
                        ...
                        if (
                            ...
                            var i = e,
                                ...
                                k = [];
                            j
                                ? (k = i.closest(a(".cbp-item")).find('[data-cbp-singlePage="' + j + '"]'))
                ...
                createMarkup: function () {
                    ...
                    "singlePage" === b.type && "left" !== b.options.singlePageAnimation && (d = " cbp-popup-singlePage-" + b.options.singlePageAnimation),
                        (b.wrap = a("<div/>", { class: "cbp-popup-wrap cbp-popup-" + b.type + d, "data-action": "lightbox" === b.type ? "close" : "" }).on("click.cbp", function (c) {
                            if (!b.stopEvents) {
                        ...
                        "ie8" === e.Private.browser && (b.bg = a("<div/>", { class: "cbp-popup-ie8bg", "data-action": "lightbox" === b.type ? "close" : "" }).appendTo(b.wrap)),
                        ...
                        (b.prevButton = a("<div/>", { class: "cbp-popup-prev", title: "Previous (Left arrow key)", "data-action": "prev" }).appendTo(b.navigation)),
                        "singlePage" === b.type &&
                            (b.options.singlePageCounter && ((b.counter = a(b.options.singlePageCounter).appendTo(b.navigation)), b.counter.text("")),
                    ...
                    if (!h.isOpen) {
                        ...
                        a.each(d, function (b, c) {
                            ...
                            if (-1 === a.inArray(e, j)) {
                                ...
                                /youtube/i.test(e)
                                    ? ((d = e.substring(e.lastIndexOf("v=") + 2)), /autoplay=/i.test(d) || (d += "&autoplay=1"), (d = d.replace(/\?|&/, "?")), (g = "//www.youtube.com/embed/" + d), (k = "isYoutube"))
                                    : /vimeo\.com/i.test(e)
                                    ? ((d = e.substring(e.lastIndexOf("/") + 1)), /autoplay=/i.test(d) || (d += "&autoplay=1"), (d = d.replace(/\?|&/, "?")), (g = "//player.vimeo.com/video/" + d), (k = "isVimeo"))
                                    : /www\.ted\.com/i.test(e)
                                    ? ((g = "http://embed.ted.com/talks/" + e.substring(e.lastIndexOf("/") + 1) + ".html"), (k = "isTed"))
                                    : /soundcloud\.com/i.test(e)
                                    ? ((g = e), (k = "isSoundCloud"))
                                    : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(e)
                                    ? ((g = e.split(-1 !== e.indexOf("|") ? "|" : "%7C")), (k = "isSelfHostedVideo"))
                                    : /\.mp3$/i.test(e) && ((g = e), (k = "isSelfHostedAudio")),
                                    h.dataArray.push({ src: g, title: c.getAttribute(h.options.lightboxTitleSrc), type: k }),
                                    i++;
                            }
                            j.push(e);
                        }),
                            (h.counterTotal = h.dataArray.length),
                            1 === h.counterTotal ? (h.nextButton.hide(), h.prevButton.hide(), (h.dataActionImg = "")) : (h.nextButton.show(), h.prevButton.show(), (h.dataActionImg = 'data-action="next"')),
                            h.wrap.appendTo(c.body),
                            (h.scrollTop = a(b).scrollTop()),
                            (h.originalStyle = a("html").attr("style")),
                            a("html").css({ overflow: "hidden", paddingRight: b.innerWidth - a(c).width() }),
                            h.wrap.show(),
                    ...
                    if (!h.isOpen) {
                        ...
                        if (
                            (a.each(d, function (b, c) {
                                ...
                                -1 === a.inArray(d, j) && (g === d && (h.current = i), h.dataArray.push({ url: d, element: c }), i++), j.push(d);
                            }),
                            (h.counterTotal = h.dataArray.length),
                            1 === h.counterTotal ? (h.nextButton.hide(), h.prevButton.hide()) : (h.nextButton.show(), h.prevButton.show()),
                            h.wrap.appendTo(c.body),
                            (h.scrollTop = a(b).scrollTop()),
                            a("html").css({ overflow: "hidden", paddingRight: b.innerWidth - a(c).width() }),
                            h.wrap.scrollTop(0),
                            ...
                            h.wrap.one(e.Private.transitionend, function () {
                                ...
                                h.options.singlePageStickyNavigation &&
                                    ...
                                    ("android" === e.Private.browser || "ios" === e.Private.browser) &&
                                        ((h.navigationMobile = a("<div/>", { class: "cbp-popup-singlePage cbp-popup-singlePage-sticky", id: h.wrap.attr("id") }).on("click.cbp", function (b) {
                                            if (!h.stopEvents) {
                                                var c = a(b.target).attr("data-action");
                                                h[c] && (h[c](), b.preventDefault());
                                            }
                                        })),
                                        h.navigationMobile.appendTo(c.body).append(h.navigationWrap))),
                                    h.finishOpen--,
                        ...
                        h.wrap.addClass("cbp-popup-loading"),
                            ...
                            h.options.singlePageDeeplinking && ((h.url = h.url.split("#cbp=")[0]), (location.href = h.url + "#cbp=" + h.dataArray[h.current].url)),
                ...
                openSinglePageInline: function (c, d, e) {
                    var f,
                        ...
                        i,
                        j = this;
                    if (((e = e || !1), (j.fromOpen = e), (j.storeBlocks = c), (j.storeCurrentBlock = d), j.isOpen))
                        return (
                            (g = a(d).closest(".cbp-item").index()),
                            void (j.dataArray[j.current].url !== d.getAttribute("href") || j.current !== g ? j.cubeportfolio.singlePageInline.close("open", { blocks: c, currentBlock: d, fromOpen: !0 }) : j.close())
                        );
                    ...
                    if (
                        ...
                        "top" === j.options.singlePageInlinePosition
                            ...
                            ? ((j.startInline = j.cubeportfolio.cols * Math.floor(j.current / j.cubeportfolio.cols)),
                              (j.top = a(c[j.current]).data("cbp").top),
                              0 === j.startInline ? (j.firstRow = !0) : ((j.top -= j.options.gapHorizontal), (j.firstRow = !1)),
                              (j.lastRow = !1))
                            : ((j.top = a(c[j.current]).data("cbp").top + a(c[j.current]).data("cbp").height),
                              (j.startInline = Math.min(j.cubeportfolio.cols * (Math.floor(j.current / j.cubeportfolio.cols) + 1), j.counterTotal)),
                              (j.firstRow = !1),
                ...
                resizeSinglePageInline: function () {
                    var a = this;
                    (a.height = a.firstRow || a.lastRow ? a.wrap.outerHeight(!0) : a.wrap.outerHeight(!0) - a.options.gapHorizontal),
                        a.storeBlocks.each(function (b, c) {
                            b < a.startInline
                                ? e.Private.modernBrowser
                                    ...
                                    : (c.style.marginTop = "")
                                : e.Private.modernBrowser
                                ? (c.style[e.Private.transform] = "translate3d(0px, " + a.height + "px, 0)")
                ...
                updateSinglePage: function (b, c, d) {
                    ...
                    f.content.addClass("cbp-popup-content").removeClass("cbp-popup-content-basic"),
                        ...
                        f.counter && ((e = a(f.getCounterMarkup(f.options.singlePageCounter, f.current + 1, f.counterTotal))), f.counter.text(e.text())),
                        f.content.html(b),
                ...
                updateSinglePageIsOpen: function () {
                    ...
                    c.wrap.addClass("cbp-popup-ready"),
                        ...
                        b
                            ? (b.find(".cbp-slider-item").addClass("cbp-item"), (c.slider = b.cubeportfolio({ layoutMode: "slider", mediaQueries: [{ width: 1, cols: 1 }], gapHorizontal: 0, gapVertical: 0, caption: "", coverRatio: "" })))
                            : (c.slider = null),
                        ("android" === e.Private.browser || "ios" === e.Private.browser) && a("html").css({ position: "fixed" }),
                    ...
                    b.cubeportfolio.loadImages(b.wrap, function () {
                        ...
                        c.length
                            ? (c.find(".cbp-slider-item").addClass("cbp-item"),
                              ...
                              (b.slider = c.cubeportfolio({ layoutMode: "slider", displayType: "default", mediaQueries: [{ width: 1, cols: 1 }], gapHorizontal: 0, gapVertical: 0, caption: "", coverRatio: "" })))
                ...
                updateSelfHostedVideo: function (a, b, c) {
                    ...
                    for (d = 0; d < a.length; d++)
                        /(\.mp4)/i.test(a[d])
                            ...
                            : /(\.webm)/i.test(a[d]) && (f += '<source src="' + a[d] + '" type="video/webm">');
                    ...
                    (h.isOpen = !1),
                        "singlePageInline" === h.type
                            ...
                            ? (h.resetWrap(),
                              ...
                              ("android" === e.Private.browser || "ios" === e.Private.browser) && (a("html").css({ position: "" }), h.navigationWrap.appendTo(h.wrap), h.navigationMobile.remove()),
                              a(b).scrollTop(h.scrollTop),
                              setTimeout(function () {
                                  (h.stopScroll = !0),
                                      h.navigationWrap.css({ top: h.wrap.scrollTop() }),
                                      h.wrap.removeClass("cbp-popup-singlePage-open cbp-popup-singlePage-sticky"),
                                      ("ie8" === e.Private.browser || "ie9" === e.Private.browser) &&
                                          (h.content.html(""), h.wrap.detach(), a("html").css({ overflow: "", paddingRight: "", position: "" }), h.navigationWrap.removeAttr("style"));
                              }, 0),
                              h.wrap.one(e.Private.transitionend, function () {
                                  h.content.html(""), h.wrap.detach(), a("html").css({ overflow: "", paddingRight: "", position: "" }), h.navigationWrap.removeAttr("style");
                              }))
                            : (h.originalStyle ? a("html").attr("style", h.originalStyle) : a("html").css({ overflow: "", paddingRight: "" }), a(b).scrollTop(h.scrollTop), h.content.html(""), h.wrap.detach());
                },
        ...
        (d.prototype.run = function () {
            ...
            (d.lightbox = null),
                d.options.lightboxDelegate &&
                    ...
                    e.on("click.cbp", d.options.lightboxDelegate, function (c) {
                        ...
                        h
                            ...
                            : (i = g.find(f ? d.options.lightboxDelegate + "[data-cbp-lightbox=" + f + "]" : d.options.lightboxDelegate)),
                ...
                d.options.singlePageDelegate &&
                    ...
                    e.on("click.cbp", d.options.singlePageDelegate, function (c) {
                        ...
                        h
                            ...
                            : (i = g.find(f ? d.options.singlePageDelegate + "[data-cbp-singlePage=" + f + "]" : d.options.singlePageDelegate)),
                ...
                d.options.singlePageDelegate &&
                    ...
                    d.$obj.on("click.cbp", d.options.singlePageInlineDelegate, function (a) {
            ...
            (d.prototype.detectScope = function (b) {
                ...
                return (
                    ...
                    d.length
                        ...
                        : ((e = b.closest(".cbp-popup-singlePage")), e.length ? ((f = b.closest(".cbp", e[0])), f.length ? f : e) : ((f = b.closest(".cbp")), f.length ? f : a(c.body)))
                );
            }),
            ...
            browserInfo: function () {
                ...
                (g.browser =
                    ...
                    typeof f !== d &&
                        ...
                        (g.transitionend = { WebkitTransition: "webkitTransitionEnd", transition: "transitionend" }[a]),
                        (c = g.styleSupport("animation")),
                        (g.animationend = { WebkitAnimation: "webkitAnimationEnd", animation: "animationend" }[c]),
                        (g.animationDuration = { WebkitAnimation: "webkitAnimationDuration", animation: "animationDuration" }[c]),
                        (g.animationDelay = { WebkitAnimation: "webkitAnimationDelay", animation: "animationDelay" }[c]),
        ...
        e.Public = {
            ...
            destroy: function (b) {
                ...
                c.triggerEvent("beforeDestroy"),
                    ...
                    c.options.caption && c.$obj.removeClass("cbp-caption-active cbp-caption-" + c.options.caption),
                    c.destroySlider(),
                    c.$ul.unwrap(),
    ...
    (function (a) {
        ...
        (b.prototype.filterLayout = function () {
            ...
            d.$obj.addClass("cbp-animation-" + d.options.animationType),
                ...
                d.blocksOn2Off.length ? d.blocksOn2Off.last().data("cbp").wrapper.one(c.Private.animationend, b) : d.blocksOff2On.length ? d.blocksOff2On.last().data("cbp").wrapper.one(c.Private.animationend, b) : b(),
                    ...
                    d.$obj.addClass("cbp-animation-" + d.options.animationType),
                        ...
                        d.blocksOn.removeClass("cbp-item-off").each(function (b, e) {
                            ...
                            (f.left = f.leftNew),
                                ...
                                "sequentially" === d.options.animationType && (f.wrapper[0].style[c.Private.animationDelay] = 60 * b + "ms");
                        }),
                        d.blocksOn.length ? d.blocksOn.last().data("cbp").wrapper.one(c.Private.animationend, b) : d.blocksOnInitial.length ? d.blocksOnInitial.last().data("cbp").wrapper.one(c.Private.animationend, b) : b(),
                        d.resizeMainContainer();
                });
        }),
            (b.prototype.destroy = function () {
            ...
            e.setAttribute("class", "cbp-wrapper-helper"),
                ...
                requestAnimationFrame(function () {
                    d.$obj.addClass("cbp-animation-" + d.options.animationType),
                        ...
                        d.blocksOn.length ? d.$ul.one(c.Private.animationend, b) : d.blocksOnInitial.length ? a(e).one(c.Private.animationend, b) : b(),
                        d.resizeMainContainer();
                });
        }),
            (b.prototype.destroy = function () {
        ...
        function b(b) {
            ...
            b.pushQueue("delayFrame", d),
                b.registerEvent(
                    "initEndWrite",
                    function () {
                        (b.obj.style[c.Private.animationDuration] = b.options.displayTypeSpeed + "ms"),
    ...
    (function (a) {
        ...
        a.extend(b.prototype, {
                    ...
                    a.each(b.freeSpaces, function (d, e) {
                        ...
                        return (
                            b.blocksOn.each(function (b, h) {
                                var i = a(h).data("cbp");
                                if (i.pack !== !0) return i.widthAndGap <= f && i.heightAndGap <= g ? ((i.pack = !0), (c = { spaceIndex: d, dataBlock: i }), (i.leftNew = e.leftStart), (i.topNew = e.topStart), !1) : void 0;
                            }),
            ...
            generateG1: function (a, b, c) {
                a.topStart !== b.topStart && c.push({ leftStart: a.leftStart, leftEnd: a.leftEnd, topStart: a.topStart, topEnd: b.topStart });
            },
            generateG2: function (a, b, c) {
                a.leftEnd !== b.leftEnd && c.push({ leftStart: b.leftEnd, leftEnd: a.leftEnd, topStart: a.topStart, topEnd: a.topEnd });
            },
            generateG3: function (a, b, c) {
                a.topEnd !== b.topEnd && c.push({ leftStart: a.leftStart, leftEnd: a.leftEnd, topStart: b.topEnd, topEnd: a.topEnd });
            },
            generateG4: function (a, b, c) {
                a.leftStart !== b.leftStart && c.push({ leftStart: a.leftStart, leftEnd: b.leftStart, topStart: a.topStart, topEnd: a.topEnd });
            },
        ...
        a.extend(e.prototype, {
            sliderMarkup: function () {
                ...
                (b.sliderStopEvents = !1),
                    ...
                    b.options.showNavigation &&
                        ...
                        (b.navPrev = a("<div/>", { class: "cbp-nav-prev", "data-slider-action": "prev" }).appendTo(b.controls)),
                        (b.navNext = a("<div/>", { class: "cbp-nav-next", "data-slider-action": "next" }).appendTo(b.controls)),
                        b.controls.appendTo(b.nav)),
                    b.options.showPagination && (b.navPagination = a("<div/>", { class: "cbp-nav-pagination" }).appendTo(b.nav)),
            ...
            jumpDragToSlider: function (a) {
                var b,
                    ...
                    e = this,
                    f = a > 0 ? !0 : !1;
                e.options.scrollByPage ? ((b = e.cols * e.columnWidth), (c = e.cols)) : ((b = e.columnWidth), (c = 1)),
                    (a = Math.abs(a)),
                    (d = Math.floor(a / b) * c),
                    a % b > 20 && (d += c),
                    (e.sliderActive = f ? Math.min(e.sliderActive + d, e.blocksOn.length - e.cols) : Math.max(0, e.sliderActive - d)),
                    e.goToSlider();
            },
            ...
            enableDisableNavSlider: function () {
                var a,
                    b,
                    c = this;
                c.isRewindNav() || ((b = c.isStartSlider() ? "addClass" : "removeClass"), c.navPrev[b]("cbp-nav-stop"), (b = c.isEndSlider() ? "addClass" : "removeClass"), c.navNext[b]("cbp-nav-stop")),
                    c.options.showPagination &&
                        ((a = c.options.scrollByPage ? Math.ceil(c.sliderActive / c.cols) : c.isEndSlider() ? c.navPaginationItems.length - 1 : Math.floor(c.sliderActive / c.cols)),
            ...
            dragSlider: function () {
                function f(b) {
                    if (!q.sliderItemsLength()) {
                        if ((u ? (p = b) : b.preventDefault(), q.options.auto && q.stopSliderAuto(), s))
                ...
                function h(a) {
                    ...
                    var b = n - l;
                    0 > l && n > l ? (b = (n - l) / 5) : l > 0 && -o > n - l && (b = -o + (o + n - l) / 5),
                ...
                function j(a) {
                    return a.originalEvent !== d && a.originalEvent.touches !== d && (a = a.originalEvent.touches[0]), { x: a.pageX, y: a.pageY };
                }
                var k,
                    l,
                    m,
                    ...
                    u = !1;
                (q.isDrag = !1),
                    "ontouchstart" in b || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0
                        ? ((t = { start: "touchstart.cbp", move: "touchmove.cbp", end: "touchend.cbp" }), (u = !0))
                        : (t = { start: "mousedown.cbp", move: "mousemove.cbp", end: "mouseup.cbp" }),
                    q.$ul.on(t.start, f);
            },
