...
<div class=" d-flex p-3 mx-auto flex-column">
  <header class="">
    <div>
    <h1 class="logo float-md-start mb-0" >PokerinPub.co.uk</h1>
  ...
  <section id="Players" class="sec1">
    <h1>Home</h1>
    <p class="lead comf">Welcome to the temporary test website of PokerinPub. We are using this website to test the technical ideas before we launch our final website.</p>
    <p class="lead">
